...
namespace Jul6Art\PdfBundle\Tests\DependencyInjection;

use Jul6Art\PdfBundle\DependencyInjection\Configuration;
...
final class ConfigurationTest extends TestCase
{
    ...
    {
        self::assertSame('pdf', new Configuration()->getConfigTreeBuilder()->buildTree()->getName());
    }

    public function testItAppliesItsDefaults(): void
    {
        self::assertSame(
            ['enabled' => true, 'public_dir' => '%kernel.project_dir%/public'],
            $this->process([]),
        );
    }
    ...
    {
        self::assertSame(
            ['enabled' => true, 'public_dir' => '/var/www/public'],
            $this->process([['enabled' => false], ['enabled' => true, 'public_dir' => '/var/www/public']]),
        );
    }
