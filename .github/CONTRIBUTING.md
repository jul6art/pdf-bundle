# Contributing to `jul6art/pdf-bundle`
...
* **Bug** → open an [issue](https://github.com/jul6art/pdf-bundle/issues/new/choose)
...
```bash
git clone https://github.com/jul6art/pdf-bundle.git
cd pdf-bundle
composer install
```

You need PHP **^8.5** and Composer 2. There is nothing to boot: the
