...
`jul6art/pdf-bundle` is installed by other applications through Composer, so
...
Use [GitHub's private vulnerability reporting](https://github.com/jul6art/pdf-bundle/security/advisories/new)
...
<!-- Bundle author: private reporting has to be switched on for that link to
     ...
     gh api -X PUT repos/jul6art/pdf-bundle/private-vulnerability-reporting -->

Please include:

* the version of `jul6art/pdf-bundle` and of Symfony you are running,
* the relevant part of your `pdf` configuration,
...
* For an accepted report: a fix released on the supported line, a
  [security advisory](https://github.com/jul6art/pdf-bundle/security/advisories)
